    ...
    <Fragment>
      <Paper variant="outlined">
        ...
        <Grid container spacing={4} columns={{ xs: 4, md: 12 }}>
          ...
          <Grid item md={7}>
            <Typography variant="h5">Information</Typography><br />
            <Typography variant="p"><strong>Status:</strong> {rick.status}</Typography><br />
            <Typography variant="p"><strong>Gender:</strong> {rick.gender}</Typography><br />
            <Typography variant="p"><strong>Species:</strong> {rick.species}</Typography><br />
          </Grid>
        </Grid>
      </Paper>
    </Fragment>
